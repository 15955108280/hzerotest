...
public class QuotationLine extends AuditDomain {
    ...
    @ApiModelProperty(
                    value = "报价单行状态SSRC.RFX_QUOTATION_LINE_STATUS(NEW/新建|SUBMITTED/已报价|BARGAINED/已还价|TAKEN_BACK/收回|ABANDONED/放弃)",
                    required = true)
    @NotBlank
    ...
    public QuotationLine(Long tenantId, Long quotationLineId) {

        this.tenantId = tenantId;
        this.quotationLineId = quotationLineId;
    }

    public QuotationLine(Long quotationHeaderId, Long tenantId, String quotationLineStatus, Long rfxLineItemId,
                    Long roundNumber, Integer taxIncludedFlag) {
        ...
        this.bargainFlag = 0;
        this.suggestedFlag = 0;
        this.abandonedFlag = 0;
    }

    public QuotationLine(Long tenantId, SavePriceDTO savePriceDTO) {
        this.tenantId = tenantId;
        this.quotationLineId = savePriceDTO.getQuotationLineId();
        this.currentPromisedDate = savePriceDTO.getCurrentPromisedDate();
        this.currentDeliveryCycle = savePriceDTO.getCurrentDeliveryCycle();
        this.currentExpiryDateFrom = savePriceDTO.getCurrentExpiryDateFrom();
        this.currentExpiryDateTo = savePriceDTO.getCurrentExpiryDateTo();
        this.currentQuotedBy = savePriceDTO.getCurrentQuotedBy();
        this.currentQuotationQuantity = savePriceDTO.getCurrentQuotationQuantity();
        this.currentQuotationPrice = savePriceDTO.getCurrentQuotationPrice();
        this.currentQuotationRemark = savePriceDTO.getCurrentQuotationRemark();
        this.currentBargainBy = savePriceDTO.getCurrentBargainBy();
        this.currentBargainQuantity = savePriceDTO.getCurrentBargainQuantity();
        this.currentBargainPrice = savePriceDTO.getCurrentBargainPrice();
        this.currentBargainRemark = savePriceDTO.getCurrentBargainRemark();
    }

    public QuotationLine(Long tenantId, SubmitPriceDTO submitPriceDTO) {
        this.tenantId = tenantId;
        this.quotationLineId = submitPriceDTO.getQuotationLineId();
        this.quotationLineId = submitPriceDTO.getQuotationLineId();
        this.validPromisedDate = submitPriceDTO.getValidPromisedDate();
        this.validDeliveryCycle = submitPriceDTO.getValidDeliveryCycle();
        this.validExpiryDateFrom = submitPriceDTO.getValidExpiryDateFrom();
        this.validQuotedBy = submitPriceDTO.getValidQuotedBy();
        this.validQuotationQuantity = submitPriceDTO.getValidQuotationQuantity();
        this.validQuotationPrice = submitPriceDTO.getValidQuotationPrice();
        this.validQuotationRemark = submitPriceDTO.getValidQuotationRemark();
        this.validBargainBy = submitPriceDTO.getValidBargainBy();
        this.validBargainQuantity = submitPriceDTO.getValidBargainQuantity();
        this.validBargainPrice = submitPriceDTO.getValidBargainPrice();
        this.validBargainRemark = submitPriceDTO.getValidBargainRemark();
        this.currentQuotedBy = null;
        this.currentQuotationQuantity = BigDecimal.valueOf(0);
    }
