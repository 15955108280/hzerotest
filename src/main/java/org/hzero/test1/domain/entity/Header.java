...
public class Header extends AuditDomain {
    ...
    public Header(Long rfxHeaderId) {
        this.rfxHeaderId = rfxHeaderId;
    }
     ...
     * 
     * @Transient private List<LineItem> lineItemList;
     */
     ...
     * 
     * public void setLineItemList(List<LineItem> lineItemList) { this.lineItemList = lineItemList; }
     */
}
